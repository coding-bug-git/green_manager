...
import cn.bug.green.common.annotation.DataScope;
...
import cn.bug.green.system.domain.SysRoleDept;
import cn.bug.green.system.domain.SysRoleMenu;
import cn.bug.green.system.domain.SysUserRole;
import cn.bug.green.system.mapper.green.SysRoleDeptMapper;
import cn.bug.green.system.mapper.green.SysRoleMapper;
import cn.bug.green.system.mapper.green.SysRoleMenuMapper;
import cn.bug.green.system.mapper.green.SysUserRoleMapper;
    ...
    public Set<String> selectRolePermissionByUserId(Long userId) {
        ...
        for (SysRole perm : perms) {
            if (StringUtils.isNotNull(perm)) {
                permsSet.addAll(List.of(perm.getRoleKey().trim().split(",")));
            }
        }
        return permsSet;
    }
